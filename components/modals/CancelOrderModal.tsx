...
export const CancelOrderModal: React.FC<CancelOrderModalProps> = ({ onSubmit, onClose }) => {
  ...
  return (
    <div className="p-4 pt-0 pb-8">
       <div className="text-center mb-6 px-4">
          ...
          <h3 className="text-[22px] font-bold text-white tracking-tight mb-2">Отмена заказа</h3>
          <p className="text-[15px] text-neutral-400">Укажите причину, чтобы мы могли передать заказ другому курьеру.</p>
       </div>

...
const REASONS = [
  ...
  'Неверный адрес или координаты',
  'Груз не готов / Поврежден',
  'Неадекватное поведение',
  'Долгое ожидание',
  'Другое'
];

export const ReportProblemModal: React.FC<ReportProblemModalProps> = ({ onClose }) => {
  ...
  const getButtonText = () => {
      ...
      if (selectedReason) return 'Отправить отчет';
  ...
  return (
    <div className="p-4 pt-0 pb-8">
       <div className="text-center mb-6 px-4">
          ...
          <h3 className="text-[22px] font-bold text-white tracking-tight mb-2">Сообщить о проблеме</h3>
          <p className="text-[15px] text-neutral-400">Что пошло не так? Мы поможем решить ситуацию.</p>
       </div>

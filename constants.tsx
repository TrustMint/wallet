...
// PROFESSIONAL IOS-STYLE ICON SET (SF Symbols Inspired)
export const Icons = {
  Package: () => (
  ...
  Plus: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14m-7-7h14"/></svg>
  ),
  List: () => (
  ...
  Wallet: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 5H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5a2 2 0 0 0-2-2h-3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h3"/><path d="M16 14h.01"/></svg>
  ),
  Message: () => (
  ...
  Check: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
  ),
  CheckLight: () => (
  ...
  CreditCard: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="22" height="16" x="1" y="4" rx="2" ry="2"/><line x1="1" x2="23" y1="10" y2="10"/></svg>
  ),
  Info: () => (
  ...
  Radar: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19.07 4.93A10 10 0 0 0 4.93 19.07"/><path d="M16.24 7.76A6 6 0 0 0 7.76 16.24"/><path d="M12 12h.01"/></svg>
  ),
  Edit: () => (
  ...
  ThumbsDown: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 14V2"/><path d="M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H19.5a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.76a2 2 0 0 0-1.79 1.11L12 22h0a3.13 3.13 0 0 1-3-3.88Z"/></svg>
  ),
  Car: () => (
...
// CENTRALIZED ORDER OPTIONS CONFIGURATION
// This ensures that badges appear consistently across all views (Create, Card, Detail)
export const ORDER_OPTIONS_CONFIG: Record<string, { label: string; icon: React.ReactNode; color: string }> = {
    'cat_docs': { label: 'Документы', icon: <Icons.FileText />, color: '#0A84FF' },
    'fragile': { label: 'Хрупкое', icon: <Icons.Shield />, color: '#BF5AF2' },
    'urgent': { label: 'Срочно', icon: <Icons.Zap />, color: '#FF3B30' },
    'door_to_door': { label: 'До двери', icon: <Icons.Box />, color: '#0A84FF' },
    'thermo': { label: 'Термо', icon: <Icons.DownloadCloud />, color: '#64D2FF' },
    'photo': { label: 'Фотоотчет', icon: <Icons.Camera />, color: '#5E5CE6' },
    'cat_tech': { label: 'Техника', icon: <Icons.Smartphone />, color: '#5E5CE6' },
    'cat_gift': { label: 'Подарок', icon: <Icons.Gift />, color: '#FF2D55' },
    'cat_food': { label: 'Еда', icon: <Icons.ShoppingBag />, color: '#FF9F0A' },
    'cat_other': { label: 'Другое', icon: <Icons.Star />, color: '#BF5AF2' }
};
